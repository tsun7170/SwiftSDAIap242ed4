/* file: a3ms_equivalence_criterion_with_specified_elements.swift 	 generated: Fri Feb 27 19:08:27 2026 */
...
/*
  ...
  END_ENTITY; -- a3ms_equivalence_criterion_with_specified_elements (line:7546 file:ap242ed4_mim_lf_TY.exp)
    ...
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP2 /* nA3MS_ELEMENT_TYPE_NAME? */ = A3MS_GET_ELEMENT_TYPE( 
            ...
            sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:(nil as SDAI.INTEGER?)] */_TEMP1) )
        ...
        let _TEMP5 /* nA3MS_ELEMENT_TYPE_NAME? */ = A3MS_GET_ELEMENT_TYPE( 
            SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>(
            bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?), /*SDAI.SET<
            sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:(nil as SDAI.INTEGER?)] */_TEMP4) )
