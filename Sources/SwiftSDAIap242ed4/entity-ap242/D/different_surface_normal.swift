/* file: different_surface_normal.swift 	 generated: Sat Feb 28 19:28:50 2026 */
...
/*
  ...
  END_ENTITY; -- different_surface_normal (line:14113 file:ap242ed4_mim_lf_TY.exp)
    ...
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      internal func _measured_data_type__getter(SELF: eDIFFERENT_SURFACE_NORMAL.PRef) -> 
        nA3MS_MEASURED_DATA_TYPE_NAME {
                let value = nA3MS_MEASURED_DATA_TYPE_NAME(/*nA3M_MEASURED_DATA_TYPE_NAME*/
          MDNS_PLANE_ANGLE_MEASURE)
        return SDAI.UNWRAP( value )
      }
