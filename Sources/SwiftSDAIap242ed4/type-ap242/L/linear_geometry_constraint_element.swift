/* file: linear_geometry_constraint_element.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  TYPE linear_geometry_constraint_element = SELECT
    ( direction (*ENTITY*),
     ...
     plane (*ENTITY*),
     vector (*ENTITY*) );
  END_TYPE; -- linear_geometry_constraint_element (line:4747 file:ap242ed4_mim_lf_TY.exp)
