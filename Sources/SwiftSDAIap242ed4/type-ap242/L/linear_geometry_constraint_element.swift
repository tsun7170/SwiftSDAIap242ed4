/* file: linear_geometry_constraint_element.swift 	 generated: Wed Feb 25 18:12:04 2026 */
...
/*
  TYPE linear_geometry_constraint_element = SELECT
    ( direction (*ENTITY*),
     ...
     plane (*ENTITY*),
     vector (*ENTITY*) );
  END_TYPE; -- linear_geometry_constraint_element (line:4737 file:ap242ed4_mim_lf.exp)
