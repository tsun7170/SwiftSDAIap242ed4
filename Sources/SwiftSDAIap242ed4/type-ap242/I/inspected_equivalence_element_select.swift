/* file: inspected_equivalence_element_select.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  TYPE inspected_equivalence_element_select = SELECT
    ( connected_edge_set (*ENTITY*),
     ...
     vertex_point (*ENTITY*) );
  END_TYPE; -- inspected_equivalence_element_select (line:4593 file:ap242ed4_mim_lf_TY.exp)
...
*/
  public enum sINSPECTED_EQUIVALENCE_ELEMENT_SELECT : SDAI.Value, TypeHierarchy.sINSPECTED_EQUIVALENCE_ELEMENT_SELECT__TypeBehavior {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_EQUIVALENCE_ELEMENT_SELECT``
    public var underlying_sPRODUCT_DEFINITION_OR_REFERENCE: sPRODUCT_DEFINITION_OR_REFERENCE? {
      switch self {
    ...
    public var underlying_ePRODUCT_DEFINITION: ePRODUCT_DEFINITION.PRef? {
      switch self {
      case ._PRODUCT_DEFINITION_OR_REFERENCE(let select): return select.underlying_ePRODUCT_DEFINITION
      default: return nil
      }
    }
    ...
    public var RISK_PERCEPTION_CONTEXT: eRISK_PERCEPTION_CONTEXT.PRef?  {
      switch self {
      case ._PRODUCT_DEFINITION_OR_REFERENCE(let select): return select.RISK_PERCEPTION_CONTEXT
      default: return nil
      }
    }
...
public protocol sINSPECTED_EQUIVALENCE_ELEMENT_SELECT__TypeBehavior: SDAI.SelectType {
  ...
  var underlying_sPRODUCT_DEFINITION_OR_REFERENCE: 
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sINSPECTED_EQUIVALENCE_ELEMENT_SELECT__Subtype {
  ...
  //MARK: UNDERLYING TYPE REFERENCES
  var underlying_sPRODUCT_DEFINITION_OR_REFERENCE: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.sPRODUCT_DEFINITION_OR_REFERENCE? { rep.underlying_sPRODUCT_DEFINITION_OR_REFERENCE }
