/* file: inspected_shape_element_select.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  ...
  END_TYPE; -- inspected_shape_element_select (line:4606 file:ap242ed4_mim_lf_TY.exp)
...
*/
  public struct sINSPECTED_SHAPE_ELEMENT_SELECT: TypeHierarchy.sINSPECTED_SHAPE_ELEMENT_SELECT__TypeBehavior {
    ...
    public static func WHERE_wr1(SELF: sINSPECTED_SHAPE_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      ...
      //
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: eDATUM.self )
    ...
    public static func WHERE_wr2(SELF: sINSPECTED_SHAPE_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      //
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: eDATUM_SYSTEM.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
    public static func WHERE_wr3(SELF: sINSPECTED_SHAPE_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      //
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: eDATUM_TARGET.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
    public static func WHERE_wr4(SELF: sINSPECTED_SHAPE_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      //
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: eDIMENSIONAL_LOCATION.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
    ...
    public static func WHERE_wr8(SELF: sINSPECTED_SHAPE_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      //
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: eTSDQ_INSPECTION_ELEMENT.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
