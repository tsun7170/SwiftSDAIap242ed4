/* file: internal_or_reflected_shape_aspect.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  TYPE internal_or_reflected_shape_aspect = SELECT
    ( identifier (*TYPE*),
     shape_aspect (*ENTITY*) );
  END_TYPE; -- internal_or_reflected_shape_aspect (line:4625 file:ap242ed4_mim_lf_TY.exp)
...
*/
  public enum sINTERNAL_OR_REFLECTED_SHAPE_ASPECT : SDAI.Value, TypeHierarchy.sINTERNAL_OR_REFLECTED_SHAPE_ASPECT__TypeBehavior {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINTERNAL_OR_REFLECTED_SHAPE_ASPECT``
    public var underlying_tIDENTIFIER: tIDENTIFIER? {
      switch self {
...
public protocol sINTERNAL_OR_REFLECTED_SHAPE_ASPECT__TypeBehavior: SDAI.SelectType {
  ...
  var underlying_tIDENTIFIER: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tIDENTIFIER? { get }
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sINTERNAL_OR_REFLECTED_SHAPE_ASPECT__Subtype {
  ...
  //MARK: UNDERLYING TYPE REFERENCES
  var underlying_tIDENTIFIER: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tIDENTIFIER? { rep.underlying_tIDENTIFIER }
