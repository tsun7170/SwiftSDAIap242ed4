/* file: generic_attribute_list_select.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  TYPE generic_attribute_list_select = SELECT
    ( address (*ENTITY*),
     person (*ENTITY*) );
  END_TYPE; -- generic_attribute_list_select (line:3955 file:ap242ed4_mim_lf_TY.exp)
...
```
*/
  public enum sGENERIC_ATTRIBUTE_LIST_SELECT : SDAI.Value, TypeHierarchy.sGENERIC_ATTRIBUTE_LIST_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eADDRESS`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGENERIC_ATTRIBUTE_LIST_SELECT``
    ...
    public static let bareTypeName: String = "GENERIC_ATTRIBUTE_LIST_SELECT"
    ...
    public static let typeName: String = 
      "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.GENERIC_ATTRIBUTE_LIST_SELECT"
...
public protocol sGENERIC_ATTRIBUTE_LIST_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sGENERIC_ATTRIBUTE_LIST_SELECT__Subtype: 
  sGENERIC_ATTRIBUTE_LIST_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sGENERIC_ATTRIBUTE_LIST_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sGENERIC_ATTRIBUTE_LIST_SELECT__Subtype {
  //MARK: CONSTRUCTORS
