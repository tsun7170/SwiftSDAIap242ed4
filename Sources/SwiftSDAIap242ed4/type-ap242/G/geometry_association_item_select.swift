/* file: geometry_association_item_select.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  TYPE geometry_association_item_select = SELECT
    ( cartesian_point (*ENTITY*),
     ...
     placement (*ENTITY*),
     vertex_point (*ENTITY*) );
  END_TYPE; -- geometry_association_item_select (line:4060 file:ap242ed4_mim_lf_TY.exp)
...
/*
  ...
  ATTR:  constrained_elements: SET [1 : 1] OF bounded_curve_with_length
...
```
*/
  public enum sGEOMETRY_ASSOCIATION_ITEM_SELECT : SDAI.Value, TypeHierarchy.sGEOMETRY_ASSOCIATION_ITEM_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCARTESIAN_POINT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGEOMETRY_ASSOCIATION_ITEM_SELECT``
    ...
    public static let bareTypeName: String = "GEOMETRY_ASSOCIATION_ITEM_SELECT"
    ...
    public var CONSTRAINED_ELEMENTS: (SDAI.SET<eBOUNDED_CURVE_WITH_LENGTH.PRef>/*[1:1]*/ )?  {
      switch self {
      case ._CURVE(let entity): return entity.CONSTRAINED_ELEMENTS
      default: return nil
      }
    }
    ...
    public static let typeName: String = 
      "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.GEOMETRY_ASSOCIATION_ITEM_SELECT"
...
public protocol sGEOMETRY_ASSOCIATION_ITEM_SELECT__TypeBehavior: SDAI.SelectType {
  ...
  var CONSTRAINED_ELEMENTS: (SDAI.SET<
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eBOUNDED_CURVE_WITH_LENGTH.PRef>/*[1:1]*/ )?  { get }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sGEOMETRY_ASSOCIATION_ITEM_SELECT__Subtype: 
  sGEOMETRY_ASSOCIATION_ITEM_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sGEOMETRY_ASSOCIATION_ITEM_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sGEOMETRY_ASSOCIATION_ITEM_SELECT__Subtype {
  //MARK: CONSTRUCTORS
  ...
  var CONSTRAINED_ELEMENTS: (SDAI.SET<
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eBOUNDED_CURVE_WITH_LENGTH.PRef>/*[1:1]*/ )?  { rep.CONSTRAINED_ELEMENTS }
