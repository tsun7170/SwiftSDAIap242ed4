/* file: effectivity_item.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  ...
  END_TYPE; -- effectivity_item (line:2972 file:ap242ed4_mim_lf_TY.exp)
...
/*
  ...
  ATTR:  description: text (AMBIGUOUS (SELECT LEVEL))
  ATTR:  parent: risk_action (AMBIGUOUS (SELECT LEVEL))
  ...
  ATTR:  parent: shape_aspect (AMBIGUOUS (SELECT LEVEL))
...
*/
  public enum sEFFECTIVITY_ITEM : SDAI.Value, TypeHierarchy.sEFFECTIVITY_ITEM__TypeBehavior {
    ...
    public var CONFIGURATION_TYPE: SDAI.STRING?  {
      ...
      case ._CONDITIONAL_EFFECTIVITY(let entity): return entity.CONFIGURATION_TYPE
      default: return nil
      }
    }
    ...
    //MARK: var PARENT: (AMBIGUOUS SOURCE; ATTRIBUTE ACCESS SUPPRESSED)
    ...
    public var INHERITANCE_TYPE: SDAI.STRING?  {
      ...
      case ._CONDITIONAL_EFFECTIVITY(let entity): return entity.INHERITANCE_TYPE
      default: return nil
      }
    }
