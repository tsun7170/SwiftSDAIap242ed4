/* file: real_interval.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  ...
  WHERE
    wr1: ( ( NOT ( 'ELEMENTARY_SPACE' IN stripped_typeof( SELF ) ) ) OR ( SELF\elementary_space.space_id = 
             es_reals ) );
  END_TYPE; -- real_interval (line:5931 file:ap242ed4_mim_lf_TY.exp)
...
*/
  public enum sREAL_INTERVAL : SDAI.Value, TypeHierarchy.sREAL_INTERVAL__TypeBehavior {
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eELEMENTARY_SPACE.self) {self = ._ELEMENTARY_SPACE(base.pRef) }
      else if let base = complex.entityReference(eFINITE_REAL_INTERVAL.self) {self = ._FINITE_REAL_INTERVAL(base.pRef) }
      else if let base = complex.entityReference(eREAL_INTERVAL_FROM_MIN.self) {self = ._REAL_INTERVAL_FROM_MIN(base.pRef) }
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sREAL_INTERVAL``
    public var underlying_eREAL_INTERVAL_FROM_MIN: eREAL_INTERVAL_FROM_MIN.PRef? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sREAL_INTERVAL``
    public var underlying_eREAL_INTERVAL_TO_MAX: eREAL_INTERVAL_TO_MAX.PRef? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sREAL_INTERVAL``
    public var underlying_eFINITE_REAL_INTERVAL: eFINITE_REAL_INTERVAL.PRef? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sREAL_INTERVAL``
    public var underlying_eELEMENTARY_SPACE: eELEMENTARY_SPACE.PRef? {
      switch self {
...
public protocol sREAL_INTERVAL__TypeBehavior: SDAI.SelectType {
  ...
  var underlying_eREAL_INTERVAL_FROM_MIN: 
  ...
  var underlying_eREAL_INTERVAL_TO_MAX: 
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sREAL_INTERVAL__Subtype {
  ...
  var underlying_eREAL_INTERVAL_FROM_MIN: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eREAL_INTERVAL_FROM_MIN.PRef? { rep.underlying_eREAL_INTERVAL_FROM_MIN }
  ...
  var underlying_eREAL_INTERVAL_TO_MAX: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eREAL_INTERVAL_TO_MAX.PRef? { rep.underlying_eREAL_INTERVAL_TO_MAX }
  ...
  var underlying_eFINITE_REAL_INTERVAL: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eFINITE_REAL_INTERVAL.PRef? { rep.underlying_eFINITE_REAL_INTERVAL }
  var underlying_eELEMENTARY_SPACE: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eELEMENTARY_SPACE.PRef? { rep.underlying_eELEMENTARY_SPACE }
