/* file: role_select.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  ...
  END_TYPE; -- role_select (line:6103 file:ap242ed4_mim_lf_TY.exp)
...
/*
  ...
  ATTR:  items: SET [1 : ?] OF project_group_name_item (AMBIGUOUS (SELECT LEVEL))
...
*/
  public enum sROLE_SELECT : SDAI.Value, TypeHierarchy.sROLE_SELECT__TypeBehavior {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sROLE_SELECT``
    public var underlying_eAPPROVAL_DATE_TIME: eAPPROVAL_DATE_TIME.PRef? {
      switch self {
...
public protocol sROLE_SELECT__TypeBehavior: SDAI.SelectType {
  ...
  var underlying_eAPPROVAL_DATE_TIME: 
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sROLE_SELECT__Subtype {
  ...
  var underlying_eAPPROVAL_DATE_TIME: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eAPPROVAL_DATE_TIME.PRef? { rep.underlying_eAPPROVAL_DATE_TIME }
