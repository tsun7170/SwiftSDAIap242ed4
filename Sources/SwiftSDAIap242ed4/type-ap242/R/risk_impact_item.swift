/* file: risk_impact_item.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  ...
  END_TYPE; -- risk_impact_item (line:6092 file:ap242ed4_mim_lf_TY.exp)
...
```
*/
  public enum sRISK_IMPACT_ITEM : SDAI.Value, TypeHierarchy.sRISK_IMPACT_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sRISK_IMPACT_ITEM``
    ...
    public static let bareTypeName: String = "RISK_IMPACT_ITEM"
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.RISK_IMPACT_ITEM"
...
public protocol sRISK_IMPACT_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sRISK_IMPACT_ITEM__Subtype: sRISK_IMPACT_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sRISK_IMPACT_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sRISK_IMPACT_ITEM__Subtype {
  //MARK: CONSTRUCTORS
