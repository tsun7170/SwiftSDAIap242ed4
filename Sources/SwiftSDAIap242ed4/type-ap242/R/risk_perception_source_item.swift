/* file: risk_perception_source_item.swift 	 generated: Fri Feb 27 19:08:27 2026 */
...
/*
  TYPE risk_perception_source_item = SELECT
    ( action (*ENTITY*),
     ...
     product (*ENTITY*) );
  END_TYPE; -- risk_perception_source_item (line:6097 file:ap242ed4_mim_lf_TY.exp)
...
```
*/
  public enum sRISK_PERCEPTION_SOURCE_ITEM : SDAI.Value, TypeHierarchy.sRISK_PERCEPTION_SOURCE_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sRISK_PERCEPTION_SOURCE_ITEM``
    ...
    public static let bareTypeName: String = "RISK_PERCEPTION_SOURCE_ITEM"
    ...
    public static let typeName: String = 
      "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.RISK_PERCEPTION_SOURCE_ITEM"
...
public protocol sRISK_PERCEPTION_SOURCE_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sRISK_PERCEPTION_SOURCE_ITEM__Subtype: 
  sRISK_PERCEPTION_SOURCE_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sRISK_PERCEPTION_SOURCE_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sRISK_PERCEPTION_SOURCE_ITEM__Subtype {
  //MARK: CONSTRUCTORS
