/* file: requirement_source_item.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  TYPE requirement_source_item = SELECT
    ( action_method (*ENTITY*),
     ...
     validation (*ENTITY*),
     verification (*ENTITY*) );
  END_TYPE; -- requirement_source_item (line:6029 file:ap242ed4_mim_lf_TY.exp)
...
/*
  ...
  ATTR:  element: shape_aspect_relationship *** Multiple Select Case Sources ***
...
*/
  public enum sREQUIREMENT_SOURCE_ITEM : SDAI.Value, TypeHierarchy.sREQUIREMENT_SOURCE_ITEM__TypeBehavior {
    ...
    public var ELEMENT: SDAI.GENERIC_ENTITY?  {
      switch self {
      case ._GROUP_RELATIONSHIP(let entity): return entity.ELEMENT?.asGenericEntityReference
      case ._SHAPE_ASPECT(let entity): return entity.ELEMENT?.asGenericEntityReference
      default: return nil
      }
    }
