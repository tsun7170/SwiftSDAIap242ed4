/* file: sketch_type_select.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  TYPE sketch_type_select = SELECT
    ( neutral_sketch_representation (*ENTITY*),
     ...
     subsketch (*ENTITY*) );
  END_TYPE; -- sketch_type_select (line:6421 file:ap242ed4_mim_lf_TY.exp)
...
*/
  public enum sSKETCH_TYPE_SELECT : SDAI.Value, TypeHierarchy.sSKETCH_TYPE_SELECT__TypeBehavior {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSKETCH_TYPE_SELECT``
    public var underlying_ePOSITIONED_SKETCH: ePOSITIONED_SKETCH.PRef? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSKETCH_TYPE_SELECT``
    public var underlying_eSUBSKETCH: eSUBSKETCH.PRef? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSKETCH_TYPE_SELECT``
    public var underlying_eNEUTRAL_SKETCH_REPRESENTATION: eNEUTRAL_SKETCH_REPRESENTATION.PRef? {
      switch self {
...
public protocol sSKETCH_TYPE_SELECT__TypeBehavior: SDAI.SelectType {
  ...
  var underlying_ePOSITIONED_SKETCH: 
  ...
  var underlying_eSUBSKETCH: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eSUBSKETCH.PRef? { get }
  var underlying_eNEUTRAL_SKETCH_REPRESENTATION: 
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sSKETCH_TYPE_SELECT__Subtype {
  ...
  //MARK: UNDERLYING TYPE REFERENCES
  var underlying_ePOSITIONED_SKETCH: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ePOSITIONED_SKETCH.PRef? { rep.underlying_ePOSITIONED_SKETCH }
  var underlying_eREPRESENTATION: 
  ...
  var underlying_eSUBSKETCH: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eSUBSKETCH.PRef? { rep.underlying_eSUBSKETCH }
  var underlying_eNEUTRAL_SKETCH_REPRESENTATION: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eNEUTRAL_SKETCH_REPRESENTATION.PRef? { rep.underlying_eNEUTRAL_SKETCH_REPRESENTATION }
