/* file: spatial_rotation.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  TYPE spatial_rotation = SELECT
    ( rotation_about_direction (*ENTITY*),
     ypr_rotation (*TYPE*) );
  END_TYPE; -- spatial_rotation (line:6447 file:ap242ed4_mim_lf_TY.exp)
...
*/
  public enum sSPATIAL_ROTATION : SDAI.Value, TypeHierarchy.sSPATIAL_ROTATION__TypeBehavior {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSPATIAL_ROTATION``
    public var underlying_tYPR_ROTATION: tYPR_ROTATION? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSPATIAL_ROTATION``
    public var underlying_eROTATION_ABOUT_DIRECTION: eROTATION_ABOUT_DIRECTION.PRef? {
      switch self {
...
public protocol sSPATIAL_ROTATION__TypeBehavior: SDAI.SelectType, SDAI.AggregationType
  ...
  var underlying_tYPR_ROTATION: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tYPR_ROTATION? { get }
  var underlying_eROTATION_ABOUT_DIRECTION: 
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sSPATIAL_ROTATION__Subtype {
  ...
  //MARK: UNDERLYING TYPE REFERENCES
  var underlying_tYPR_ROTATION: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tYPR_ROTATION? { rep.underlying_tYPR_ROTATION }
  var underlying_eROTATION_ABOUT_DIRECTION: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eROTATION_ABOUT_DIRECTION.PRef? { rep.underlying_eROTATION_ABOUT_DIRECTION }
