/* file: surface_style_element_select.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  ...
  END_TYPE; -- surface_style_element_select (line:6657 file:ap242ed4_mim_lf_TY.exp)
...
*/
  public enum sSURFACE_STYLE_ELEMENT_SELECT : SDAI.Value, TypeHierarchy.sSURFACE_STYLE_ELEMENT_SELECT__TypeBehavior {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_STYLE_ELEMENT_SELECT``
    public var underlying_eSURFACE_STYLE_RENDERING: eSURFACE_STYLE_RENDERING.PRef? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_STYLE_ELEMENT_SELECT``
    public var underlying_eSURFACE_STYLE_CONTROL_GRID: eSURFACE_STYLE_CONTROL_GRID.PRef? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_STYLE_ELEMENT_SELECT``
    public var underlying_eSURFACE_STYLE_PARAMETER_LINE: eSURFACE_STYLE_PARAMETER_LINE.PRef? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_STYLE_ELEMENT_SELECT``
    public var underlying_eSURFACE_STYLE_SEGMENTATION_CURVE: eSURFACE_STYLE_SEGMENTATION_CURVE.PRef? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_STYLE_ELEMENT_SELECT``
    public var underlying_eSURFACE_STYLE_BOUNDARY: eSURFACE_STYLE_BOUNDARY.PRef? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_STYLE_ELEMENT_SELECT``
    public var underlying_eSURFACE_STYLE_FILL_AREA: eSURFACE_STYLE_FILL_AREA.PRef? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_STYLE_ELEMENT_SELECT``
    public var underlying_eSURFACE_STYLE_SILHOUETTE: eSURFACE_STYLE_SILHOUETTE.PRef? {
      switch self {
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sSURFACE_STYLE_ELEMENT_SELECT__Subtype {
  ...
  var underlying_eSURFACE_STYLE_RENDERING: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eSURFACE_STYLE_RENDERING.PRef? { rep.underlying_eSURFACE_STYLE_RENDERING }
  var underlying_eSURFACE_STYLE_CONTROL_GRID: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eSURFACE_STYLE_CONTROL_GRID.PRef? { rep.underlying_eSURFACE_STYLE_CONTROL_GRID }
  var underlying_eSURFACE_STYLE_PARAMETER_LINE: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eSURFACE_STYLE_PARAMETER_LINE.PRef? { rep.underlying_eSURFACE_STYLE_PARAMETER_LINE }
  var underlying_eSURFACE_STYLE_SEGMENTATION_CURVE: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eSURFACE_STYLE_SEGMENTATION_CURVE.PRef? { rep.underlying_eSURFACE_STYLE_SEGMENTATION_CURVE }
  var underlying_eSURFACE_STYLE_BOUNDARY: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eSURFACE_STYLE_BOUNDARY.PRef? { rep.underlying_eSURFACE_STYLE_BOUNDARY }
  var underlying_eSURFACE_STYLE_FILL_AREA: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eSURFACE_STYLE_FILL_AREA.PRef? { rep.underlying_eSURFACE_STYLE_FILL_AREA }
  var underlying_eSURFACE_STYLE_SILHOUETTE: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eSURFACE_STYLE_SILHOUETTE.PRef? { rep.underlying_eSURFACE_STYLE_SILHOUETTE }
