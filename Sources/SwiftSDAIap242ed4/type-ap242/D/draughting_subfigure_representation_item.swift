/* file: draughting_subfigure_representation_item.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  ...
  END_TYPE; -- draughting_subfigure_representation_item (line:2942 file:ap242ed4_mim_lf_TY.exp)
...
*/
  public enum sDRAUGHTING_SUBFIGURE_REPRESENTATION_ITEM : SDAI.Value, TypeHierarchy.sDRAUGHTING_SUBFIGURE_REPRESENTATION_ITEM__TypeBehavior {
    ...
    public var IMAGE: eDOCUMENT.PRef?  {
      switch self {
      case ._ANNOTATION_OCCURRENCE(let entity): return entity.IMAGE
      default: return nil
      }
    }
    ...
    public var LEADER_LINE: (SDAI.SET<eANNOTATION_PLACEHOLDER_LEADER_LINE.PRef>/*[1:?]*/ )?  {
      switch self {
      case ._ANNOTATION_OCCURRENCE(let entity): return entity.LEADER_LINE
      default: return nil
      }
    }
