/* file: datum_or_common_datum.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  TYPE datum_or_common_datum = SELECT
    ( common_datum_list (*TYPE*),
     datum (*ENTITY*) );
  END_TYPE; -- datum_or_common_datum (line:2393 file:ap242ed4_mim_lf_TY.exp)
...
*/
  public enum sDATUM_OR_COMMON_DATUM : SDAI.Value, TypeHierarchy.sDATUM_OR_COMMON_DATUM__TypeBehavior {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATUM_OR_COMMON_DATUM``
    public var underlying_tCOMMON_DATUM_LIST: tCOMMON_DATUM_LIST? {
      switch self {
...
public protocol sDATUM_OR_COMMON_DATUM__TypeBehavior: SDAI.SelectType, SDAI.AggregationType
  ...
  var underlying_tCOMMON_DATUM_LIST: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tCOMMON_DATUM_LIST? { get }
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sDATUM_OR_COMMON_DATUM__Subtype {
  ...
  //MARK: UNDERLYING TYPE REFERENCES
  var underlying_tCOMMON_DATUM_LIST: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tCOMMON_DATUM_LIST? { rep.underlying_tCOMMON_DATUM_LIST }
