/* file: datum_system_or_reference.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  TYPE datum_system_or_reference = SELECT
    ( datum_reference (*ENTITY*),
     datum_system (*ENTITY*) );
  END_TYPE; -- datum_system_or_reference (line:2410 file:ap242ed4_mim_lf_TY.exp)
...
*/
  public enum sDATUM_SYSTEM_OR_REFERENCE : SDAI.Value, TypeHierarchy.sDATUM_SYSTEM_OR_REFERENCE__TypeBehavior {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATUM_SYSTEM_OR_REFERENCE``
    public var underlying_eDATUM_REFERENCE: eDATUM_REFERENCE.PRef? {
      switch self {
...
public protocol sDATUM_SYSTEM_OR_REFERENCE__TypeBehavior: SDAI.SelectType {
  ...
  var underlying_eDATUM_REFERENCE: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDATUM_REFERENCE.PRef? { get }
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sDATUM_SYSTEM_OR_REFERENCE__Subtype {
  ...
  var underlying_eDATUM_REFERENCE: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDATUM_REFERENCE.PRef? { rep.underlying_eDATUM_REFERENCE }
