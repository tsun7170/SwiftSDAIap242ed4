/* file: product_definition_or_assembly_component_usage.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  ...
  END_TYPE; -- product_definition_or_assembly_component_usage (line:5824 file:ap242ed4_mim_lf_TY.exp)
...
```
*/
  public enum sPRODUCT_DEFINITION_OR_ASSEMBLY_COMPONENT_USAGE : SDAI.Value, 
    TypeHierarchy.sPRODUCT_DEFINITION_OR_ASSEMBLY_COMPONENT_USAGE__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASSEMBLY_COMPONENT_USAGE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRODUCT_DEFINITION_OR_ASSEMBLY_COMPONENT_USAGE``
    ...
    public static let bareTypeName: String = "PRODUCT_DEFINITION_OR_ASSEMBLY_COMPONENT_USAGE"
    ...
    public static let typeName: String = 
      "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PRODUCT_DEFINITION_OR_ASSEMBLY_COMPONENT_USAGE"
...
public protocol sPRODUCT_DEFINITION_OR_ASSEMBLY_COMPONENT_USAGE__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sPRODUCT_DEFINITION_OR_ASSEMBLY_COMPONENT_USAGE__Subtype: 
  sPRODUCT_DEFINITION_OR_ASSEMBLY_COMPONENT_USAGE__TypeBehavior, SDAI.DefinedType
where Supertype: sPRODUCT_DEFINITION_OR_ASSEMBLY_COMPONENT_USAGE__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sPRODUCT_DEFINITION_OR_ASSEMBLY_COMPONENT_USAGE__Subtype {
  //MARK: CONSTRUCTORS
