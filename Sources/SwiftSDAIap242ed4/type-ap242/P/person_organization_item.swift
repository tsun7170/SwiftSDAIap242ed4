/* file: person_organization_item.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  TYPE person_organization_item = SELECT
    ( person (*ENTITY*) );
  END_TYPE; -- person_organization_item (line:5611 file:ap242ed4_mim_lf_TY.exp)
...
```
*/
  public enum sPERSON_ORGANIZATION_ITEM : SDAI.Value, TypeHierarchy.sPERSON_ORGANIZATION_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePERSON`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPERSON_ORGANIZATION_ITEM``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(ePERSON.self) {self = ._PERSON(base.pRef) }
      else { return nil }
    }
    ...
    public static let bareTypeName: String = "PERSON_ORGANIZATION_ITEM"
    ...
    public static let typeName: String = 
      "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PERSON_ORGANIZATION_ITEM"
...
public protocol sPERSON_ORGANIZATION_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sPERSON_ORGANIZATION_ITEM__Subtype: 
  sPERSON_ORGANIZATION_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sPERSON_ORGANIZATION_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sPERSON_ORGANIZATION_ITEM__Subtype {
  //MARK: CONSTRUCTORS
