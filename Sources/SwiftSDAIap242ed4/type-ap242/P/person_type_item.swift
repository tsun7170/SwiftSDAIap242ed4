/* file: person_type_item.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  ...
  END_TYPE; -- person_type_item (line:5621 file:ap242ed4_mim_lf_TY.exp)
...
```
*/
  public enum sPERSON_TYPE_ITEM : SDAI.Value, TypeHierarchy.sPERSON_TYPE_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANALYSIS_ASSIGNMENT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPERSON_TYPE_ITEM``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eANALYSIS_ASSIGNMENT.self) {self = ._ANALYSIS_ASSIGNMENT(base.pRef) }
      else { return nil }
    }
    ...
    public static let bareTypeName: String = "PERSON_TYPE_ITEM"
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PERSON_TYPE_ITEM"
...
public protocol sPERSON_TYPE_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sPERSON_TYPE_ITEM__Subtype: sPERSON_TYPE_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sPERSON_TYPE_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sPERSON_TYPE_ITEM__Subtype {
  //MARK: CONSTRUCTORS
