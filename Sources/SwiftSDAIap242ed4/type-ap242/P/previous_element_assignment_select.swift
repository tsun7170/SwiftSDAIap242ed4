/* file: previous_element_assignment_select.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  ...
  END_TYPE; -- previous_element_assignment_select (line:5808 file:ap242ed4_mim_lf_TY.exp)
...
*/
  public enum sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT : SDAI.Value, TypeHierarchy.sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT__TypeBehavior {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT``
    public var underlying_eDELETE_ELEMENT: eDELETE_ELEMENT.PRef? {
      switch self {
...
public protocol sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT__TypeBehavior: SDAI.SelectType {
  ...
  var underlying_eDELETE_ELEMENT: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDELETE_ELEMENT.PRef? { get }
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT__Subtype {
  ...
  var underlying_eDELETE_ELEMENT: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDELETE_ELEMENT.PRef? { rep.underlying_eDELETE_ELEMENT }
  var underlying_eMODIFY_ELEMENT: 
