/* file: position_in_organization_group_item.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  ...
  END_TYPE; -- position_in_organization_group_item (line:5710 file:ap242ed4_mim_lf_TY.exp)
...
```
*/
  public enum sPOSITION_IN_ORGANIZATION_GROUP_ITEM : SDAI.Value, TypeHierarchy.sPOSITION_IN_ORGANIZATION_GROUP_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_FORMATION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPOSITION_IN_ORGANIZATION_GROUP_ITEM``
    ...
    public static let bareTypeName: String = "POSITION_IN_ORGANIZATION_GROUP_ITEM"
    ...
    public static let typeName: String = 
      "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.POSITION_IN_ORGANIZATION_GROUP_ITEM"
...
public protocol sPOSITION_IN_ORGANIZATION_GROUP_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sPOSITION_IN_ORGANIZATION_GROUP_ITEM__Subtype: 
  sPOSITION_IN_ORGANIZATION_GROUP_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sPOSITION_IN_ORGANIZATION_GROUP_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sPOSITION_IN_ORGANIZATION_GROUP_ITEM__Subtype {
  //MARK: CONSTRUCTORS
