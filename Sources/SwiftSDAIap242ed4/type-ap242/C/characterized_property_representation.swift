/* file: characterized_property_representation.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  ...
  END_TYPE; -- characterized_property_representation (line:1701 file:ap242ed4_mim_lf_TY.exp)
...
*/
  public enum sCHARACTERIZED_PROPERTY_REPRESENTATION : SDAI.Value, TypeHierarchy.sCHARACTERIZED_PROPERTY_REPRESENTATION__TypeBehavior {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHARACTERIZED_PROPERTY_REPRESENTATION``
    public var underlying_eRESOURCE_PROPERTY_REPRESENTATION: eRESOURCE_PROPERTY_REPRESENTATION.PRef? {
      switch self {
    ...
    public var LIMITS: (SDAI.LIST_UNIQUE<eSHAPE_DIMENSION_REPRESENTATION.PRef>/*[2:?]*/ )?  {
      switch self {
      case ._DIMENSIONAL_CHARACTERISTIC_REPRESENTATION(let entity): return entity.LIMITS
      default: return nil
      }
    }
...
public protocol sCHARACTERIZED_PROPERTY_REPRESENTATION__TypeBehavior: SDAI.SelectType {
  ...
  var underlying_eRESOURCE_PROPERTY_REPRESENTATION: 
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sCHARACTERIZED_PROPERTY_REPRESENTATION__Subtype {
  ...
  var underlying_eRESOURCE_PROPERTY_REPRESENTATION: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eRESOURCE_PROPERTY_REPRESENTATION.PRef? { rep.underlying_eRESOURCE_PROPERTY_REPRESENTATION }
