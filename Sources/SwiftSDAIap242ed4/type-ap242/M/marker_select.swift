/* file: marker_select.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  ...
  END_TYPE; -- marker_select (line:4879 file:ap242ed4_mim_lf_TY.exp)
...
*/
  public enum sMARKER_SELECT : SDAI.Value, TypeHierarchy.sMARKER_SELECT__TypeBehavior {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMARKER_SELECT``
    public var underlying_nMARKER_TYPE: nMARKER_TYPE? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMARKER_SELECT``
    public var underlying_ePRE_DEFINED_MARKER: ePRE_DEFINED_MARKER.PRef? {
      switch self {
...
public protocol sMARKER_SELECT__TypeBehavior: SDAI.SelectType {
  ...
  var underlying_nMARKER_TYPE: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nMARKER_TYPE? { get }
  var underlying_ePRE_DEFINED_ITEM: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ePRE_DEFINED_ITEM.PRef? { get }
  var underlying_ePRE_DEFINED_MARKER: 
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sMARKER_SELECT__Subtype {
  ...
  //MARK: UNDERLYING TYPE REFERENCES
  var underlying_nMARKER_TYPE: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nMARKER_TYPE? { rep.underlying_nMARKER_TYPE }
  ...
  var underlying_ePRE_DEFINED_MARKER: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ePRE_DEFINED_MARKER.PRef? { rep.underlying_ePRE_DEFINED_MARKER }
