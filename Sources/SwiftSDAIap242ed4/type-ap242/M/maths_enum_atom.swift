/* file: maths_enum_atom.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  TYPE maths_enum_atom = SELECT
    ( elementary_function_enumerators (*ENUM*),
     ...
     symmetry_type (*ENUM*) );
  END_TYPE; -- maths_enum_atom (line:4908 file:ap242ed4_mim_lf_TY.exp)
...
*/
  public enum sMATHS_ENUM_ATOM : SDAI.Value, TypeHierarchy.sMATHS_ENUM_ATOM__TypeBehavior {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ENUM_ATOM``
    public var underlying_nELEMENTARY_FUNCTION_ENUMERATORS: nELEMENTARY_FUNCTION_ENUMERATORS? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ENUM_ATOM``
    public var underlying_nELEMENTARY_SPACE_ENUMERATORS: nELEMENTARY_SPACE_ENUMERATORS? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ENUM_ATOM``
    public var underlying_nEXTENSION_OPTIONS: nEXTENSION_OPTIONS? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ENUM_ATOM``
    public var underlying_nLOWER_UPPER: nLOWER_UPPER? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ENUM_ATOM``
    public var underlying_nOPEN_CLOSED: nOPEN_CLOSED? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ENUM_ATOM``
    public var underlying_nORDERING_TYPE: nORDERING_TYPE? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ENUM_ATOM``
    public var underlying_nREPACKAGE_OPTIONS: nREPACKAGE_OPTIONS? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ENUM_ATOM``
    public var underlying_nSPACE_CONSTRAINT_TYPE: nSPACE_CONSTRAINT_TYPE? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ENUM_ATOM``
    public var underlying_nSYMMETRY_TYPE: nSYMMETRY_TYPE? {
      switch self {
...
public protocol sMATHS_ENUM_ATOM__TypeBehavior: SDAI.SelectType {
  ...
  var underlying_nELEMENTARY_FUNCTION_ENUMERATORS: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nELEMENTARY_FUNCTION_ENUMERATORS? { get }
  var underlying_nELEMENTARY_SPACE_ENUMERATORS: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nELEMENTARY_SPACE_ENUMERATORS? { get }
  var underlying_nEXTENSION_OPTIONS: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nEXTENSION_OPTIONS? { get }
  var underlying_nLOWER_UPPER: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nLOWER_UPPER? { get }
  var underlying_nOPEN_CLOSED: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nOPEN_CLOSED? { get }
  var underlying_nORDERING_TYPE: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nORDERING_TYPE? { get }
  var underlying_nREPACKAGE_OPTIONS: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nREPACKAGE_OPTIONS? { get }
  var underlying_nSPACE_CONSTRAINT_TYPE: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nSPACE_CONSTRAINT_TYPE? { get }
  var underlying_nSYMMETRY_TYPE: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nSYMMETRY_TYPE? { get }
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sMATHS_ENUM_ATOM__Subtype {
  ...
  //MARK: UNDERLYING TYPE REFERENCES
  var underlying_nELEMENTARY_FUNCTION_ENUMERATORS: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nELEMENTARY_FUNCTION_ENUMERATORS? { rep.underlying_nELEMENTARY_FUNCTION_ENUMERATORS }
  var underlying_nELEMENTARY_SPACE_ENUMERATORS: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nELEMENTARY_SPACE_ENUMERATORS? { rep.underlying_nELEMENTARY_SPACE_ENUMERATORS }
  var underlying_nEXTENSION_OPTIONS: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nEXTENSION_OPTIONS? { rep.underlying_nEXTENSION_OPTIONS }
  var underlying_nLOWER_UPPER: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nLOWER_UPPER? { rep.underlying_nLOWER_UPPER }
  var underlying_nOPEN_CLOSED: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nOPEN_CLOSED? { rep.underlying_nOPEN_CLOSED }
  var underlying_nORDERING_TYPE: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nORDERING_TYPE? { rep.underlying_nORDERING_TYPE }
  var underlying_nREPACKAGE_OPTIONS: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nREPACKAGE_OPTIONS? { rep.underlying_nREPACKAGE_OPTIONS }
  var underlying_nSPACE_CONSTRAINT_TYPE: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nSPACE_CONSTRAINT_TYPE? { rep.underlying_nSPACE_CONSTRAINT_TYPE }
  var underlying_nSYMMETRY_TYPE: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nSYMMETRY_TYPE? { rep.underlying_nSYMMETRY_TYPE }
