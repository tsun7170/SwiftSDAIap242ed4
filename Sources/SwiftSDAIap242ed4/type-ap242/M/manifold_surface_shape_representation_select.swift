/* file: manifold_surface_shape_representation_select.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  ...
  END_TYPE; -- manifold_surface_shape_representation_select (line:4873 file:ap242ed4_mim_lf_TY.exp)
...
```
*/
  public enum sMANIFOLD_SURFACE_SHAPE_REPRESENTATION_SELECT : SDAI.Value, 
    TypeHierarchy.sMANIFOLD_SURFACE_SHAPE_REPRESENTATION_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAXIS2_PLACEMENT_3D`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMANIFOLD_SURFACE_SHAPE_REPRESENTATION_SELECT``
    ...
    public static let bareTypeName: String = "MANIFOLD_SURFACE_SHAPE_REPRESENTATION_SELECT"
    ...
    public static let typeName: String = 
      "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.MANIFOLD_SURFACE_SHAPE_REPRESENTATION_SELECT"
...
public protocol sMANIFOLD_SURFACE_SHAPE_REPRESENTATION_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sMANIFOLD_SURFACE_SHAPE_REPRESENTATION_SELECT__Subtype: 
  sMANIFOLD_SURFACE_SHAPE_REPRESENTATION_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sMANIFOLD_SURFACE_SHAPE_REPRESENTATION_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sMANIFOLD_SURFACE_SHAPE_REPRESENTATION_SELECT__Subtype {
  //MARK: CONSTRUCTORS
