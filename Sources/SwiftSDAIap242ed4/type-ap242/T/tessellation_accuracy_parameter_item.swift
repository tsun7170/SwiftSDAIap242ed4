/* file: tessellation_accuracy_parameter_item.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  ...
  END_TYPE; -- tessellation_accuracy_parameter_item (line:6740 file:ap242ed4_mim_lf_TY.exp)
...
*/
  public enum sTESSELLATION_ACCURACY_PARAMETER_ITEM : SDAI.Value, TypeHierarchy.sTESSELLATION_ACCURACY_PARAMETER_ITEM__TypeBehavior {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTESSELLATION_ACCURACY_PARAMETER_ITEM``
    public var underlying_tANGULAR_DEVIATION: tANGULAR_DEVIATION? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTESSELLATION_ACCURACY_PARAMETER_ITEM``
    public var underlying_tCHORDAL_DEVIATION: tCHORDAL_DEVIATION? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTESSELLATION_ACCURACY_PARAMETER_ITEM``
    public var underlying_tLENGTH_TO_HEIGHT_RATIO: tLENGTH_TO_HEIGHT_RATIO? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTESSELLATION_ACCURACY_PARAMETER_ITEM``
    public var underlying_tMAXIMUM_EDGE_LENGTH: tMAXIMUM_EDGE_LENGTH? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTESSELLATION_ACCURACY_PARAMETER_ITEM``
    public var underlying_tTESSELLATED_FACET_LONG_SHORT_EDGE_RATIO: 
      tTESSELLATED_FACET_LONG_SHORT_EDGE_RATIO? {
      switch self {
...
public protocol sTESSELLATION_ACCURACY_PARAMETER_ITEM__TypeBehavior: SDAI.SelectType {
  ...
  var underlying_tANGULAR_DEVIATION: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tANGULAR_DEVIATION? { get }
  var underlying_tCHORDAL_DEVIATION: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tCHORDAL_DEVIATION? { get }
  var underlying_tLENGTH_TO_HEIGHT_RATIO: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tLENGTH_TO_HEIGHT_RATIO? { get }
  var underlying_tMAXIMUM_EDGE_LENGTH: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tMAXIMUM_EDGE_LENGTH? { get }
  var underlying_tTESSELLATED_FACET_LONG_SHORT_EDGE_RATIO: 
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sTESSELLATION_ACCURACY_PARAMETER_ITEM__Subtype {
  ...
  //MARK: UNDERLYING TYPE REFERENCES
  var underlying_tANGULAR_DEVIATION: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tANGULAR_DEVIATION? { rep.underlying_tANGULAR_DEVIATION }
  var underlying_tCHORDAL_DEVIATION: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tCHORDAL_DEVIATION? { rep.underlying_tCHORDAL_DEVIATION }
  var underlying_tLENGTH_TO_HEIGHT_RATIO: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tLENGTH_TO_HEIGHT_RATIO? { rep.underlying_tLENGTH_TO_HEIGHT_RATIO }
  var underlying_tMAXIMUM_EDGE_LENGTH: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tMAXIMUM_EDGE_LENGTH? { rep.underlying_tMAXIMUM_EDGE_LENGTH }
  var underlying_tTESSELLATED_FACET_LONG_SHORT_EDGE_RATIO: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tTESSELLATED_FACET_LONG_SHORT_EDGE_RATIO? { rep.underlying_tTESSELLATED_FACET_LONG_SHORT_EDGE_RATIO }
