/* file: tessellated_surface_item.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  ...
  END_TYPE; -- tessellated_surface_item (line:6733 file:ap242ed4_mim_lf_TY.exp)
...
*/
  public enum sTESSELLATED_SURFACE_ITEM : SDAI.Value, TypeHierarchy.sTESSELLATED_SURFACE_ITEM__TypeBehavior {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTESSELLATED_SURFACE_ITEM``
    public var underlying_eTESSELLATED_SHELL: eTESSELLATED_SHELL.PRef? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTESSELLATED_SURFACE_ITEM``
    public var underlying_eTESSELLATED_SOLID: eTESSELLATED_SOLID.PRef? {
      switch self {
...
public protocol sTESSELLATED_SURFACE_ITEM__TypeBehavior: SDAI.SelectType {
  ...
  var underlying_eTESSELLATED_SHELL: 
  ...
  var underlying_eTESSELLATED_SOLID: 
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sTESSELLATED_SURFACE_ITEM__Subtype {
  ...
  var underlying_eTESSELLATED_SHELL: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eTESSELLATED_SHELL.PRef? { rep.underlying_eTESSELLATED_SHELL }
  ...
  var underlying_eTESSELLATED_SOLID: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eTESSELLATED_SOLID.PRef? { rep.underlying_eTESSELLATED_SOLID }
