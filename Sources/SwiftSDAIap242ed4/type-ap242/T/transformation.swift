/* file: transformation.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  ...
  END_TYPE; -- transformation (line:6888 file:ap242ed4_mim_lf_TY.exp)
...
*/
  public enum sTRANSFORMATION : SDAI.Value, TypeHierarchy.sTRANSFORMATION__TypeBehavior {
    ...
    public init?<T: SDAI.UnderlyingType>(possiblyFrom underlyingType: T?){
      ...
      if let base = underlyingType as? tSET_ITEM_DEFINED_TRANSFORMATION {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTRANSFORMATION``
    public var underlying_tSET_ITEM_DEFINED_TRANSFORMATION: tSET_ITEM_DEFINED_TRANSFORMATION? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTRANSFORMATION``
    public var underlying_eITEM_DEFINED_TRANSFORMATION: eITEM_DEFINED_TRANSFORMATION.PRef? {
      switch self {
...
public protocol sTRANSFORMATION__TypeBehavior: SDAI.SelectType, SDAI.AggregationType
  ...
  var underlying_tSET_ITEM_DEFINED_TRANSFORMATION: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tSET_ITEM_DEFINED_TRANSFORMATION? { get }
  var underlying_eITEM_DEFINED_TRANSFORMATION: 
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sTRANSFORMATION__Subtype {
  ...
  //MARK: UNDERLYING TYPE REFERENCES
  var underlying_tSET_ITEM_DEFINED_TRANSFORMATION: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tSET_ITEM_DEFINED_TRANSFORMATION? { rep.underlying_tSET_ITEM_DEFINED_TRANSFORMATION }
  var underlying_eITEM_DEFINED_TRANSFORMATION: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eITEM_DEFINED_TRANSFORMATION.PRef? { rep.underlying_eITEM_DEFINED_TRANSFORMATION }
