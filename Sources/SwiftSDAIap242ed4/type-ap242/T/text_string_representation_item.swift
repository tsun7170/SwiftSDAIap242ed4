/* file: text_string_representation_item.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  TYPE text_string_representation_item = SELECT
    ( annotation_text (*ENTITY*),
     ...
     text_literal (*ENTITY*) );
  END_TYPE; -- text_string_representation_item (line:6772 file:ap242ed4_mim_lf_TY.exp)
...
*/
  public enum sTEXT_STRING_REPRESENTATION_ITEM : SDAI.Value, TypeHierarchy.sTEXT_STRING_REPRESENTATION_ITEM__TypeBehavior {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTEXT_STRING_REPRESENTATION_ITEM``
    public var underlying_eANNOTATION_TEXT_CHARACTER: eANNOTATION_TEXT_CHARACTER.PRef? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTEXT_STRING_REPRESENTATION_ITEM``
    public var underlying_eCOMPOSITE_TEXT: eCOMPOSITE_TEXT.PRef? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTEXT_STRING_REPRESENTATION_ITEM``
    public var underlying_eTEXT_LITERAL: eTEXT_LITERAL.PRef? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTEXT_STRING_REPRESENTATION_ITEM``
    public var underlying_eDEFINED_CHARACTER_GLYPH: eDEFINED_CHARACTER_GLYPH.PRef? {
      switch self {
...
public protocol sTEXT_STRING_REPRESENTATION_ITEM__TypeBehavior: SDAI.SelectType {
  ...
  var underlying_eANNOTATION_TEXT_CHARACTER: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eANNOTATION_TEXT_CHARACTER.PRef? { get }
  var underlying_eCOMPOSITE_TEXT: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eCOMPOSITE_TEXT.PRef? { get }
  var underlying_eTEXT_LITERAL: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eTEXT_LITERAL.PRef? { get }
  var underlying_eDEFINED_CHARACTER_GLYPH: 
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sTEXT_STRING_REPRESENTATION_ITEM__Subtype {
  ...
  var underlying_eANNOTATION_TEXT_CHARACTER: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eANNOTATION_TEXT_CHARACTER.PRef? { rep.underlying_eANNOTATION_TEXT_CHARACTER }
  var underlying_eCOMPOSITE_TEXT: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eCOMPOSITE_TEXT.PRef? { rep.underlying_eCOMPOSITE_TEXT }
  var underlying_eTEXT_LITERAL: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eTEXT_LITERAL.PRef? { rep.underlying_eTEXT_LITERAL }
  var underlying_eDEFINED_CHARACTER_GLYPH: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDEFINED_CHARACTER_GLYPH.PRef? { rep.underlying_eDEFINED_CHARACTER_GLYPH }
