/* file: hybrid_brep_surface_select.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  TYPE hybrid_brep_surface_select = SELECT
    ( surface (*ENTITY*),
     tessellated_face (*ENTITY*) );
  END_TYPE; -- hybrid_brep_surface_select (line:4299 file:ap242ed4_mim_lf_TY.exp)
...
/*
  ...
  ATTR:  normals: LIST [0 : ?] OF LIST [3 : 3] OF REAL
  ATTR:  geometric_link: face_or_surface
  ATTR:  coordinates: coordinates_list
  ATTR:  triangle_strips: LIST [0 : ?] OF LIST [3 : ?] OF INTEGER
  ATTR:  triangles: LIST [1 : ?] OF LIST [3 : 3] OF INTEGER
  ATTR:  pnindex:  (AMBIGUOUS (CASE LEVEL))
  ATTR:  pnmax: INTEGER
  ATTR:  name: label
  ATTR:  triangle_fans: LIST [0 : ?] OF LIST [3 : ?] OF INTEGER
  ATTR:  dim: dimension_count
...
```
*/
  public enum sHYBRID_BREP_SURFACE_SELECT : SDAI.Value, TypeHierarchy.sHYBRID_BREP_SURFACE_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sHYBRID_BREP_SURFACE_SELECT``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eSURFACE.self) {self = ._SURFACE(base.pRef) }
    ...
    public static let bareTypeName: String = "HYBRID_BREP_SURFACE_SELECT"
    ...
    public var GEOMETRIC_LINK: sFACE_OR_SURFACE?  {
      switch self {
      case ._TESSELLATED_FACE(let entity): return entity.GEOMETRIC_LINK
      default: return nil
      }
    }
    ...
    public static let typeName: String = 
      "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.HYBRID_BREP_SURFACE_SELECT"
...
public protocol sHYBRID_BREP_SURFACE_SELECT__TypeBehavior: SDAI.SelectType {
  ...
  var GEOMETRIC_LINK: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.sFACE_OR_SURFACE?  { get }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sHYBRID_BREP_SURFACE_SELECT__Subtype: 
  sHYBRID_BREP_SURFACE_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sHYBRID_BREP_SURFACE_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sHYBRID_BREP_SURFACE_SELECT__Subtype {
  //MARK: CONSTRUCTORS
  ...
  var GEOMETRIC_LINK: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.sFACE_OR_SURFACE?  { rep.GEOMETRIC_LINK }
