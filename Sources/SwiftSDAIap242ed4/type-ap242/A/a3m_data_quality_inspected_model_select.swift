/* file: a3m_data_quality_inspected_model_select.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  TYPE a3m_data_quality_inspected_model_select = SELECT
    ( draughting_model (*ENTITY*),
     shape_representation (*ENTITY*) );
  END_TYPE; -- a3m_data_quality_inspected_model_select (line:199 file:ap242ed4_mim_lf_TY.exp)
...
```
*/
  public enum sA3M_DATA_QUALITY_INSPECTED_MODEL_SELECT : SDAI.Value, TypeHierarchy.sA3M_DATA_QUALITY_INSPECTED_MODEL_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDRAUGHTING_MODEL`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sA3M_DATA_QUALITY_INSPECTED_MODEL_SELECT``
    ...
    public static let bareTypeName: String = "A3M_DATA_QUALITY_INSPECTED_MODEL_SELECT"
    ...
    public static let typeName: String = 
      "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.A3M_DATA_QUALITY_INSPECTED_MODEL_SELECT"
...
public protocol sA3M_DATA_QUALITY_INSPECTED_MODEL_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sA3M_DATA_QUALITY_INSPECTED_MODEL_SELECT__Subtype: 
  sA3M_DATA_QUALITY_INSPECTED_MODEL_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sA3M_DATA_QUALITY_INSPECTED_MODEL_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sA3M_DATA_QUALITY_INSPECTED_MODEL_SELECT__Subtype {
  //MARK: CONSTRUCTORS
