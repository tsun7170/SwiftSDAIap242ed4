/* file: atom_based_value.swift 	 generated: Mon Mar 30 15:41:24 2026 */
...
/*
  TYPE atom_based_value = SELECT
    ( atom_based_tuple (*TYPE*),
     maths_atom (*SELECT*) );
  END_TYPE; -- atom_based_value (line:1058 file:ap242ed4_mim_lf_TY.exp)
...
*/
  public enum sATOM_BASED_VALUE : SDAI.Value, TypeHierarchy.sATOM_BASED_VALUE__TypeBehavior {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sATOM_BASED_VALUE``
    public var underlying_tATOM_BASED_TUPLE: tATOM_BASED_TUPLE? {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sATOM_BASED_VALUE``
    public var underlying_sMATHS_ATOM: sMATHS_ATOM? {
      switch self {
...
public protocol sATOM_BASED_VALUE__TypeBehavior: SDAI.SelectType, SDAI.AggregationType
  ...
  var underlying_tATOM_BASED_TUPLE: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tATOM_BASED_TUPLE? { get }
  var underlying_sMATHS_ATOM: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.sMATHS_ATOM? { get }
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sATOM_BASED_VALUE__Subtype {
  ...
  //MARK: UNDERLYING TYPE REFERENCES
  var underlying_tATOM_BASED_TUPLE: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tATOM_BASED_TUPLE? { rep.underlying_tATOM_BASED_TUPLE }
  var underlying_sMATHS_ATOM: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.sMATHS_ATOM? { rep.underlying_sMATHS_ATOM }
