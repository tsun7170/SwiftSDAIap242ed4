/* file: convert_to_maths_value.swift 	 generated: Wed Feb 25 18:12:04 2026 */
...
```express
  ...
  END_FUNCTION; -- convert_to_maths_value (line:41089 file:ap242ed4_mim_lf.exp)
  ...
  func CONVERT_TO_MATHS_VALUE<gG: SDAI.GenericType>( _ VAL: gG?  ) 
    ...
    if SDAI.IS_TRUE( _TEMP10 ) {
      if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/SDAI.SIZEOF( 
          SDAI.AGGREGATE<SDAI.GENERIC>(fromGeneric: /*gG*/VAL) )) {
        for I in incrementControl { SDAI.TOUCH(let: I)
          
          let _TEMP11 /* SDAI.GENERIC? */ = VAL?[I]
